...
- Validation rejects any `FabPass_` actor with meaningful pitch or roll and requires all four original placements, their exact meshes/tags/transforms, and clean classic-FBX bounds plus authored box colliders for the imported Blender props.
