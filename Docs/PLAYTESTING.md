...
19. Inspect `Embermere_FenwatchHandcart_CottageWest_01` at
    ...
    the bed, axle/wheel zone, and two rests are solid; handles, grips, cargo,
    wheel spokes/rims, and crest remain clear; and the PlayerStart-to-Mara,
...
20. Inspect `Embermere_FenwatchFirewoodRack_CottageWest_01` at
    ...
    structural sides, and chopping block are solid; individual logs, roof,
    axe, trim, and crest remain clear; and the PlayerStart-to-Mara,
    west-cottage-bypass, cottage-to-handcart work lane, and village-to-road
    ...
    behavior.
21. Inspect `Embermere_FenwatchHitchingTrough_CottageWest_01` at
    `(-3550, -520, 0)`, yaw `38`. Its long timber trough, moss feed bed, stone
    feet, iron bands, elevated hitch rail, three rings, and ember crest should
    complete one readable working-yard cluster with the handcart and firewood
    rack. Confirm the broad trough body and hitching rail are solid; feed,
    feet, bands, rings, caps, braces, trim, and crest remain clear; and the
    PlayerStart-to-Mara, west-cottage-bypass, cottage-to-handcart,
    west-utility, and village-to-road lanes remain open. The trough is
    presentation-only and must own no quest, interaction, service, recovery,
    reward, vendor, trainer, or persistence behavior.
22. Inspect `Embermere_FenwatchGatewatchPost_EastRoad_01` at
    `(220, -650, 0)`, yaw `20`. Its raised timber platform, entry step, rear
    wall, four posts, moss roof, bell, route map, horn, spears, and ember crest
    should read as a compact village threshold from the normal east-road
    approach. Confirm the platform, step, wall, and four posts are solid; roof,
    bell, railings, map, horn, spears, trim, and crest remain clear; and the
    PlayerStart-to-Mara, village-to-road, east-road, and outer-bypass lanes
