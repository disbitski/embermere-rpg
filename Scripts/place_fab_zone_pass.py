...
def spawn(entry):
    ...
    apply_project_material_overrides(actor_ref, entry["name"])
...
def apply_project_material_overrides(actor_ref, label):
    ...
    if materials:
        objects("set_properties", {
            ...
            "values": json.dumps({
                "OverrideMaterials": [{"refPath": material} for material in materials],
            }),
        })
...
PLACEMENTS = [
    ...
    {"name": FAB_PREFIX + "Village_Crates_A", "asset": SCI_CRATE_GROUP, "x": -1545, "y": -920, "z": 0, "yaw": 12, "scale": 0.9, "folder": "04_Fab_Zone_Pass/01_Village"},
    {"name": FAB_PREFIX + "Village_Crate_B", "asset": SCI_CRATE, "x": -2060, "y": -650, "z": 0, "yaw": 74, "scale": 0.8, "folder": "04_Fab_Zone_Pass/01_Village"},
    {"name": FAB_PREFIX + "Village_Crate_C", "asset": SCI_CRATE_2, "x": -1320, "y": -1120, "z": 0, "yaw": -20, "scale": 0.85, "folder": "04_Fab_Zone_Pass/01_Village"},
    {"name": FAB_PREFIX + "Village_Fence_01", "asset": SCI_FENCE, "x": -1580, "y": -1375, "z": 0, "yaw": 74, "scale": 1.2, "folder": "04_Fab_Zone_Pass/01_Village"},
    {"name": FAB_PREFIX + "Village_Fence_02", "asset": SCI_FENCE, "x": -2380, "y": -700, "z": 0, "yaw": -35, "scale": 1.2, "folder": "04_Fab_Zone_Pass/01_Village"},
    {"name": FAB_PREFIX + "Village_Fence_03", "asset": SCI_FENCE, "x": -980, "y": -800, "z": 0, "yaw": 28, "scale": 1.2, "folder": "04_Fab_Zone_Pass/01_Village"},

    # Road and wilderness boundary.
    {"name": FAB_PREFIX + "Road_Pine_01", "asset": KITE_TREE, "x": -1260, "y": -725, "z": 0, "yaw": 12, "scale": 0.52, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Pine_02", "asset": KITE_TALL_TREE, "x": -820, "y": -650, "z": 0, "yaw": -25, "scale": 0.5, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Pine_03", "asset": KITE_HILL_TREE, "x": -420, "y": -390, "z": 0, "yaw": 61, "scale": 0.44, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Pine_04", "asset": KITE_TREE, "x": 250, "y": -155, "z": 0, "yaw": 30, "scale": 0.5, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Pine_05", "asset": KITE_TALL_TREE, "x": 845, "y": 150, "z": 0, "yaw": -35, "scale": 0.48, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Pine_06", "asset": KITE_HILL_TREE, "x": 1380, "y": 290, "z": 0, "yaw": 14, "scale": 0.43, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Boulder_01", "asset": KITE_ROCK, "x": -230, "y": 285, "z": 0, "yaw": -22, "scale": 0.75, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Boulder_02", "asset": KITE_RIVER_ROCK, "x": 525, "y": 690, "z": 0, "yaw": 88, "scale": 0.9, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Bush_01", "asset": KITE_BUSH, "x": -1060, "y": -125, "z": 0, "yaw": 0, "scale": 0.85, "folder": "04_Fab_Zone_Pass/02_Road"},
    {"name": FAB_PREFIX + "Road_Bush_02", "asset": KITE_BUSH_2, "x": 80, "y": 410, "z": 0, "yaw": 0, "scale": 0.85, "folder": "04_Fab_Zone_Pass/02_Road"},
    ...
    {"name": FAB_PREFIX + "Wild_Tree_North_01", "asset": KITE_TALL_TREE, "x": 1450, "y": 1460, "z": 0, "yaw": 12, "scale": 0.55, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Tree_North_02", "asset": KITE_TREE, "x": 2030, "y": 1575, "z": 0, "yaw": -30, "scale": 0.55, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Tree_North_03", "asset": KITE_HILL_TREE, "x": 2680, "y": 1430, "z": 0, "yaw": 38, "scale": 0.48, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Tree_South_01", "asset": KITE_TREE, "x": 1340, "y": 95, "z": 0, "yaw": 15, "scale": 0.5, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Tree_South_02", "asset": KITE_TALL_TREE, "x": 1980, "y": -120, "z": 0, "yaw": -14, "scale": 0.5, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Tree_East_01", "asset": KITE_HILL_TREE, "x": 3200, "y": 1080, "z": 0, "yaw": 42, "scale": 0.5, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Rock_01", "asset": PARAGON_NORDIC_ROCK, "x": 1550, "y": 310, "z": 0, "yaw": 65, "scale": 0.72, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Rock_02", "asset": KITE_BOULDER, "x": 2840, "y": 1180, "z": 0, "yaw": 22, "scale": 0.68, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Rock_03", "asset": KITE_RIVER_ROCK, "x": 2460, "y": 210, "z": 0, "yaw": -18, "scale": 0.9, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Soul_Rock_01", "asset": SOUL_ROCK, "x": 3060, "y": 560, "z": 0, "yaw": 104, "scale": 1.05, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Bush_01", "asset": KITE_BUSH, "x": 1680, "y": 1260, "z": 0, "yaw": 0, "scale": 1.0, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Bush_02", "asset": KITE_BUSH_2, "x": 2250, "y": 1320, "z": 0, "yaw": 0, "scale": 1.0, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Ferns_01", "asset": KITE_FERN, "x": 1415, "y": 780, "z": 0, "yaw": -35, "scale": 1.25, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Ferns_02", "asset": KITE_FERN, "x": 2605, "y": 980, "z": 0, "yaw": 28, "scale": 1.25, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Roots_01", "asset": SOUL_ROOTS, "x": 1160, "y": 1030, "z": 0, "yaw": 46, "scale": 0.8, "folder": "04_Fab_Zone_Pass/03_Wilderness"},
    {"name": FAB_PREFIX + "Wild_Roots_02", "asset": SOUL_ROOTS, "x": 2940, "y": 1320, "z": 0, "yaw": -12, "scale": 0.8, "folder": "04_Fab_Zone_Pass/03_Wilderness"},

    # Ruin landmark.
    {"name": FAB_PREFIX + "Ruin_Main_Arch", "asset": PARAGON_ARCH, "x": 2645, "y": 410, "z": 0, "yaw": 90, "scale": 0.82, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Secondary_Arch", "asset": PARAGON_ARCH_B, "x": 2845, "y": 650, "z": 0, "yaw": 48, "scale": 0.58, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Wall_A", "asset": PARAGON_WALL, "x": 2400, "y": 360, "z": 0, "yaw": 82, "scale": 0.7, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Wall_B", "asset": PARAGON_WALL_CURVE, "x": 3060, "y": 820, "z": 0, "yaw": -35, "scale": 0.65, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Pillar_A", "asset": PARAGON_PILLAR, "x": 2480, "y": 680, "z": 0, "yaw": 15, "scale": 0.75, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Pillar_B", "asset": PARAGON_PILLAR_B, "x": 2915, "y": 330, "z": 0, "yaw": -24, "scale": 0.75, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Broken_Soul_Pillar", "asset": SOUL_BROKEN_PILLAR, "x": 3130, "y": 560, "z": 0, "yaw": 35, "scale": 0.8, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Rubble_A", "asset": PARAGON_RUBBLE, "x": 2575, "y": 875, "z": 0, "yaw": 0, "scale": 0.85, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Rubble_B", "asset": PARAGON_AGORA_REMAINS, "x": 3020, "y": 1015, "z": 0, "yaw": -18, "scale": 0.7, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Stairs", "asset": PARAGON_STAIRS, "x": 2260, "y": 730, "z": 0, "yaw": 44, "scale": 0.72, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Statue_Base", "asset": PARAGON_STATUE_BASE, "x": 3180, "y": 900, "z": 0, "yaw": -125, "scale": 0.52, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Statue", "asset": PARAGON_STATUE, "x": 3200, "y": 900, "z": 68, "yaw": -125, "scale": 0.52, "folder": "04_Fab_Zone_Pass/04_Ruins", "snap": False},
    {"name": FAB_PREFIX + "Ruin_Agora_Pillar", "asset": PARAGON_AGORA_PILLAR, "x": 2300, "y": 515, "z": 0, "yaw": 28, "scale": 0.52, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Small_Rock_A", "asset": SOUL_SMALL_ROCK, "x": 2385, "y": 895, "z": 0, "yaw": 42, "scale": 1.15, "folder": "04_Fab_Zone_Pass/04_Ruins"},
    {"name": FAB_PREFIX + "Ruin_Small_Rock_B", "asset": SOUL_SMALL_ROCK, "x": 3300, "y": 715, "z": 0, "yaw": -10, "scale": 1.0, "folder": "04_Fab_Zone_Pass/04_Ruins"},
